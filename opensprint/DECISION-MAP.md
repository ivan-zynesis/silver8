...
| DEC-007 | 0 | DS-COINBASE-WS, DS-BRIEF | DEC-008, DEC-027, DEC-030 | 7 |
| DEC-008 | 1 | DEC-007 | — | 0 |
...
- **DEC-004** (Three Seams) — blast **13** — touches every component plus the lifecycle ADR.
- **DEC-001** (TS on Node) — blast **11** — language change cascades through framework, monorepo, lifecycle, and deployment.
- **DEC-007** (Venue Adapter) — blast **7** — now also parents the catalog initiative; touches DEC-008, DEC-027, DEC-029, DEC-030, DEC-031, DEC-032, DEC-033.
- **DEC-002** (NestJS) — blast **6** — composition framework affects all variants and downstream.
- **DEC-016** (Three deployment variants) — blast **5** — owns MODE-selected composition, scale, and integration test path.
...
DEC-003, DEC-008, DEC-011, DEC-014, DEC-020, DEC-021, DEC-023, DEC-026, DEC-029, DEC-032, DEC-033.
